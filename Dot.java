...
public class Dot  extends Actor
{
    private int x;
    private int y; 
    private int d; // d = number of dots in world
    ...
    /**
     * lead controls the movement of head of the snake
    ...
    private void lookForEdge()
    {
        if( isAtEdge() )
        {
           getWorld().showText("Better Luck Next Time", getWorld().getWidth()/2, getWorld().getHeight()/2);
           Greenfoot.stop();
        }
    }

    /**
     * lookForFood checks if our Snake is touching Food 
     * and grows its tail if we have eaten Food
     * @param There are no parameters
    ...
    /**
     * follow handles movement for every body part of snake
